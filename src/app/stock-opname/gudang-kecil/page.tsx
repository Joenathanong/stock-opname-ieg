        ...
        <div className="flex items-center gap-2 text-xs">
          {[
            ...
            <div key={n} className="flex items-center gap-2">
              <div className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full font-medium ${step === n ? 'bg-green-600 text-white' : step > n ? 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400' : 'bg-gray-100 text-gray-500 dark:bg-gray-700 dark:text-gray-400'}`}>
                <span>{n}</span>
                <span>{label}</span>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 space-y-5">
          ...
          {barcode && (
            <div className="flex items-center gap-2 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
              ...
              <span className="font-mono text-sm font-semibold text-green-700 dark:text-green-400 flex-1">{barcode}</span>
              <button onClick={() => { setBarcode(''); setStep(1); }} className="text-xs text-gray-400 hover:text-red-500">
                Ganti
              </button>
            </div>
          )}
          ...
          {step >= 2 && barcode && (
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-green-500 text-xl font-semibold"
              />
              <div className="mt-3">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">
                  Catatan (opsional)
              ...
              <Button onClick={() => setStep(3)} className="w-full mt-3 bg-green-600 hover:bg-green-700">
                <MapPin size={16} />
                Lanjut Scan Lokasi
              </Button>
            </div>
